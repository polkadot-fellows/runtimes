...
- Add foreign-consensus cousin asset hub as trusted aliaser to allow XCMv5 origin preservation for parachains [polkadot-fellows/runtimes/pull/794](https://github.com/polkadot-fellows/runtimes/pull/794))
