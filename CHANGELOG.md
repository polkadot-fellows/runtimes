...
- Coretime Kusama: bulk revenue now accumulates with dust and is burnt on Asset Hub through `pallet-accumulate-and-forward`, and a migration retires the `py/ctbrn` holding account ([#1290](https://github.com/polkadot-fellows/runtimes/issues/1290)).
