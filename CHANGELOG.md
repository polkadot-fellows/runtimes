...
- People Polkadot: pay XCM delivery fees in any asset governance registered a rate for in `pallet-asset-rate`, not only DOT ([#1258](https://github.com/polkadot-fellows/runtimes/pull/1258)).
