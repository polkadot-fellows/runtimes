...
- Add balance to StakingPot accounts for benchmarks for all system parachains ([polkadot-fellows/runtimes/pull/729](https://github.com/polkadot-fellows/runtimes/pull/729))
