...
- People Polkadot: add the Individuality pallets: `pallet-airdrop`, `pallet-chunks-manager`, `pallet-coinage`, `pallet-dummy-dim`, `pallet-game`, `pallet-honour`, `pallet-members`, `pallet-members-notifier`, `pallet-network-suffix`, `pallet-nft-credits`, `pallet-parameters`, `pallet-people`, `pallet-people-airdrops`, `pallet-people-lite`, `pallet-relay-randomness`, `pallet-resources`, `pallet-score`, and `pallet-verify-signature` ([#1233](https://github.com/polkadot-fellows/runtimes/pull/1233)).
