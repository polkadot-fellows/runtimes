...
- Encointer: add pallets `offline-payment` and `reputation-rings` ([polkadot-fellows/runtimes/pull/1082](https://github.com/polkadot-fellows/runtimes/pull/1082))
...
- Encointer: Fix enactment of approved swap options [#1081](https://github.com/polkadot-fellows/runtimes/pull/1081)
