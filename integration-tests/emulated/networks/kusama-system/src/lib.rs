...
// TODO(encointer stable2606): pub use encointer_kusama_emulated_chain;
...
// TODO(encointer stable2606): use encointer_kusama_emulated_chain::EncointerKusama;
...
decl_test_networks! {
	pub struct KusamaMockNet {
		...
		parachains = vec![
			...
			PeopleKusama,
			CoretimeKusama,
			// TODO(encointer stable2606): EncointerKusama,
		],
		bridge = ()
	},
}
...
decl_test_sender_receiver_accounts_parameter_types! {
	...
	// TODO(encointer stable2606): EncointerKusamaPara { sender: ALICE, receiver: BOB }
}
