...
fn transfer_foreign_assets_from_asset_hub_to_para() {
	...
	let sender_wnds_before = AssetHubPolkadot::execute_with(|| {
	...
	let sender_wnds_after = AssetHubPolkadot::execute_with(|| {
		type ForeignAssets = <AssetHubPolkadot as AssetHubPolkadotPallet>::ForeignAssets;
		<ForeignAssets as Inspect<_>>::balance(
			wnd_at_rococo_parachains.clone().try_into().unwrap(),
			&sender,
...
fn transfer_foreign_assets_from_para_to_asset_hub() {
	...
	let receiver_wnds_before = AssetHubPolkadot::execute_with(|| {
		type ForeignAssets = <AssetHubPolkadot as AssetHubPolkadotPallet>::ForeignAssets;
		<ForeignAssets as Inspect<_>>::balance(
			wnd_at_rococo_parachains.clone().try_into().unwrap(),
			&receiver,
	...
	let receiver_wnds_after = AssetHubPolkadot::execute_with(|| {
		type ForeignAssets = <AssetHubPolkadot as AssetHubPolkadotPallet>::ForeignAssets;
		<ForeignAssets as Inspect<_>>::balance(
...
fn transfer_foreign_assets_from_para_to_para_through_asset_hub() {
	...
	let sender = PenpalBSender::get();
	let roc_to_send: Balance = POLKADOT_ED * 10000;
	let assets_owner = PenpalAssetOwner::get();
	let roc_location = DotLocation::get();
	...
	let wnd_to_send = ASSET_HUB_POLKADOT_ED * 10_000_000;
	...
	// Register WND as foreign asset and transfer it around the Polkadot ecosystem
	let wnd_at_rococo_parachains =
		Location::new(2, [Junction::GlobalConsensus(NetworkId::Westend)]);
	AssetHubPolkadot::force_create_foreign_asset(
		wnd_at_rococo_parachains.clone().try_into().unwrap(),
	...
	let wnds_in_sender_reserve_on_ahr_before = AssetHubPolkadot::execute_with(|| {
	...
	let wnds_in_receiver_reserve_on_ahr_before = AssetHubPolkadot::execute_with(|| {
		type Assets = <AssetHubPolkadot as AssetHubPolkadotPallet>::ForeignAssets;
		<Assets as Inspect<_>>::balance(
			wnd_at_rococo_parachains.clone().try_into().unwrap(),
	...
	let wnds_in_sender_reserve_on_ahr_after = AssetHubPolkadot::execute_with(|| {
		type Assets = <AssetHubPolkadot as AssetHubPolkadotPallet>::ForeignAssets;
		<Assets as Inspect<_>>::balance(
			wnd_at_rococo_parachains.clone().try_into().unwrap(),
			&sov_of_sender_on_ah,
	...
	let wnds_in_receiver_reserve_on_ahr_after = AssetHubPolkadot::execute_with(|| {
		type Assets = <AssetHubPolkadot as AssetHubPolkadotPallet>::ForeignAssets;
		<Assets as Inspect<_>>::balance(
			wnd_at_rococo_parachains.clone().try_into().unwrap(),
			&sov_of_receiver_on_ah,
