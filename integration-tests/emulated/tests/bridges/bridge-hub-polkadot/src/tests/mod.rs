...
// DOT and wDOT
pub(crate) fn dot_at_ah_polkadot() -> xcm::v5::Location {
	xcm::v5::Parent.into()
}
...
pub(crate) fn create_foreign_on_ah_kusama(id: xcm::v5::Location, sufficient: bool) {
...
// set up pool
pub(crate) fn set_up_pool_with_ksm_on_ah_kusama(asset: xcm::v5::Location, is_foreign: bool) {
	let ksm: xcm::v5::Location = xcm::v5::Parent.into();
	AssetHubKusama::execute_with(|| {
