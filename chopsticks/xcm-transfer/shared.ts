...
import type { TestType as KusamaAssetHubTestType } from './kusama-assethub.test'
import type { TestType as PolkadotAssetHubTestType } from './polkadot-assethub.test'

type TestType =
  | KusamaAssetHubTestType
  | PolkadotAssetHubTestType
