...
impl<T: frame_system::Config> pallet_migrations::WeightInfo for WeightInfo<T> {
	...
	fn clear_historic(n: u32, ) -> Weight {
		...
		Weight::from_parts(17_229_785, 0)
			.saturating_add(Weight::from_parts(0, 3834))
			// Standard Error: 7_882
			.saturating_add(Weight::from_parts(1_212_827, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1))
	...
	fn reset_pallet_migration(n: u32, ) -> Weight {
		...
		Weight::from_parts(31_390_563, 0)
			.saturating_add(Weight::from_parts(0, 792))
			// Standard Error: 6_478
			.saturating_add(Weight::from_parts(735_274, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
