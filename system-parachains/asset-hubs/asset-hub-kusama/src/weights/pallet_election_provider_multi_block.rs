...
impl<T: frame_system::Config> pallet_election_provider_multi_block::WeightInfo for WeightInfo<T> {
	...
	fn per_block_snapshot_msp() -> Weight {
		...
		//  Measured:  `118990`
		//  Estimated: `6309955`
		// Minimum execution time: 12_741_767_000 picoseconds.
		Weight::from_parts(13_174_527_000, 0)
	...
	fn per_block_snapshot_rest() -> Weight {
		...
		//  Measured:  `1398346`
		//  Estimated: `3339736`
		// Minimum execution time: 28_549_517_000 picoseconds.
		Weight::from_parts(30_305_428_000, 0)
	...
	/// Storage: `Staking::ErasValidatorIncentiveWeight` (r:135 w:0)
	/// Proof: `Staking::ErasValidatorIncentiveWeight` (`max_values`: None, `max_size`: Some(68), added: 2543, mode: `Measured`)
	/// Storage: `Staking::OptimumSelfStake` (r:1 w:0)
	/// Proof: `Staking::OptimumSelfStake` (`max_values`: Some(1), `max_size`: Some(16), added: 511, mode: `Measured`)
	/// Storage: `Staking::HardCapSelfStake` (r:1 w:0)
	/// Proof: `Staking::HardCapSelfStake` (`max_values`: Some(1), `max_size`: Some(16), added: 511, mode: `Measured`)
	/// Storage: `Staking::SelfStakeSlopeFactor` (r:1 w:0)
	/// Proof: `Staking::SelfStakeSlopeFactor` (`max_values`: Some(1), `max_size`: Some(4), added: 499, mode: `Measured`)
	...
	fn export_non_terminal() -> Weight {
		...
		//  Measured:  `180457`
		//  Estimated: `2300047`
		// Minimum execution time: 16_233_138_000 picoseconds.
		Weight::from_parts(16_741_310_000, 0)
			.saturating_add(Weight::from_parts(0, 2300047))
			.saturating_add(T::DbWeight::get().reads(1859))
			.saturating_add(T::DbWeight::get().writes(3402))
	}
	/// Storage: `MultiBlockElection::CurrentPhase` (r:1 w:1)
	/// Proof: `MultiBlockElection::CurrentPhase` (`max_values`: Some(1), `max_size`: Some(5), added: 500, mode: `Measured`)
	...
	/// Proof: `Staking::ErasStakersPaged` (`max_values`: None, `max_size`: Some(24656), added: 27131, mode: `Measured`)
	/// Storage: `Staking::ErasValidatorIncentiveWeight` (r:52 w:0)
	/// Proof: `Staking::ErasValidatorIncentiveWeight` (`max_values`: None, `max_size`: Some(68), added: 2543, mode: `Measured`)
	/// Storage: `Staking::OptimumSelfStake` (r:1 w:0)
	/// Proof: `Staking::OptimumSelfStake` (`max_values`: Some(1), `max_size`: Some(16), added: 511, mode: `Measured`)
	/// Storage: `Staking::HardCapSelfStake` (r:1 w:0)
	...
	fn export_terminal() -> Weight {
		...
		//  Measured:  `2633124`
		//  Estimated: `5027439`
		// Minimum execution time: 29_987_447_000 picoseconds.
		Weight::from_parts(32_036_708_000, 0)
			.saturating_add(Weight::from_parts(0, 5027439))
			.saturating_add(T::DbWeight::get().reads(3014))
			.saturating_add(T::DbWeight::get().writes(2960))
	}
	/// Storage: `MultiBlockElection::CurrentPhase` (r:1 w:0)
	/// Proof: `MultiBlockElection::CurrentPhase` (`max_values`: Some(1), `max_size`: Some(5), added: 500, mode: `Measured`)
	/// Storage: `MultiBlockElection::Round` (r:1 w:0)
	...
	fn manage_fallback() -> Weight {
		...
		//  Measured:  `352685`
		//  Estimated: `358625`
		// Minimum execution time: 954_444_528_000 picoseconds.
		Weight::from_parts(1_018_454_662_000, 0)
	...
	fn admin_set() -> Weight {
		...
		//  Measured:  `308`
		//  Estimated: `3773`
		// Minimum execution time: 240_020_000 picoseconds.
		Weight::from_parts(276_770_000, 0)
