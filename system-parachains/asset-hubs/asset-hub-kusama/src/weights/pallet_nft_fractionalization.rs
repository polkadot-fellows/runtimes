...
impl<T: frame_system::Config> pallet_nft_fractionalization::WeightInfo for WeightInfo<T> {
	...
	fn fractionalize() -> Weight {
		...
		//  Measured:  `3266`
		//  Estimated: `4326`
		// Minimum execution time: 191_389_000 picoseconds.
		Weight::from_parts(199_340_000, 0)
	...
	fn unify() -> Weight {
		...
		//  Measured:  `2918`
		//  Estimated: `4326`
		// Minimum execution time: 128_010_000 picoseconds.
		Weight::from_parts(133_410_000, 0)
			.saturating_add(Weight::from_parts(0, 4326))
			.saturating_add(T::DbWeight::get().reads(9))
