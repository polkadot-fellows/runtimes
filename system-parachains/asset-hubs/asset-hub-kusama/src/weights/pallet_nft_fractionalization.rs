...
impl<T: frame_system::Config> pallet_nft_fractionalization::WeightInfo for WeightInfo<T> {
	...
	fn fractionalize() -> Weight {
		...
		//  Measured:  `462`
		//  Estimated: `4326`
		// Minimum execution time: 216_802_000 picoseconds.
		Weight::from_parts(217_672_000, 0)
	...
	fn unify() -> Weight {
		...
		//  Measured:  `1275`
		//  Estimated: `4326`
		// Minimum execution time: 159_652_000 picoseconds.
		Weight::from_parts(160_922_000, 0)
			.saturating_add(Weight::from_parts(0, 4326))
			.saturating_add(T::DbWeight::get().reads(9))
