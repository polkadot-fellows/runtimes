...
impl<T: frame_system::Config> pallet_xcm_benchmarks::generic::WeightInfo for WeightInfo<T> {
	...
	fn report_holding() -> Weight {
		...
		Weight::from_parts(123_771_000, 0)
	...
	fn report_error() -> Weight {
		...
		//  Measured:  `397`
		//  Estimated: `6196`
		// Minimum execution time: 81_411_000 picoseconds.
	...
	fn report_transact_status() -> Weight {
		...
		Weight::from_parts(85_791_000, 0)
			.saturating_add(Weight::from_parts(0, 6196))
			.saturating_add(T::DbWeight::get().reads(7))
			.saturating_add(T::DbWeight::get().writes(4))
	}
	...
	fn exchange_asset() -> Weight {
		...
		//  Measured:  `531`
		//  Estimated: `4273`
		// Minimum execution time: 82_751_000 picoseconds.
