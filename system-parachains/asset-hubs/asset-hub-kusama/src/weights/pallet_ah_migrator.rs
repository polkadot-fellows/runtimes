...
impl<T: frame_system::Config> pallet_ah_migrator::WeightInfo for WeightInfo<T> {
	...
	fn receive_multisigs(n: u32, ) -> Weight {
		...
		Weight::from_parts(27_662_722, 990)
			// Standard Error: 32_977
			.saturating_add(Weight::from_parts(12_293_548, 0).saturating_mul(n.into()))
	...
	fn receive_accounts(n: u32, ) -> Weight {
		...
		Weight::from_parts(76_000_000, 990)
			// Standard Error: 115_935
			.saturating_add(Weight::from_parts(79_977_723, 0).saturating_mul(n.into()))
	...
	fn receive_liquid_accounts(n: u32, ) -> Weight {
		...
		Weight::from_parts(29_197_116, 990)
			// Standard Error: 90_686
			.saturating_add(Weight::from_parts(21_037_397, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
			.saturating_add(Weight::from_parts(0, 2603).saturating_mul(n.into()))
	}
	...
	fn receive_claims(n: u32, ) -> Weight {
		...
		Weight::from_parts(1_558_714, 990)
			// Standard Error: 5_562
			.saturating_add(Weight::from_parts(1_873_441, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	...
	fn receive_proxy_proxies(n: u32, ) -> Weight {
		...
		Weight::from_parts(819_951, 990)
			// Standard Error: 4_351
			.saturating_add(Weight::from_parts(2_774_169, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	...
	fn receive_proxy_announcements(n: u32, ) -> Weight {
		...
		Weight::from_parts(21_218_940, 990)
			// Standard Error: 48_709
			.saturating_add(Weight::from_parts(13_517_778, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
			.saturating_add(Weight::from_parts(0, 2603).saturating_mul(n.into()))
	}
	...
	fn receive_vesting_schedules(n: u32, ) -> Weight {
		...
		Weight::from_parts(11_000_000, 990)
			...
			.saturating_add(Weight::from_parts(3_230_053, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
	...
	fn receive_nom_pools_messages(n: u32, ) -> Weight {
		...
		Weight::from_parts(13_000_000, 1489)
			...
			.saturating_add(Weight::from_parts(4_296_718, 0).saturating_mul(n.into()))
	...
	fn receive_single_active_referendums(m: u32, ) -> Weight {
		...
		Weight::from_parts(8_000_000, 3609)
			// Standard Error: 9
			.saturating_add(Weight::from_parts(2_010, 0).saturating_mul(m.into()))
	...
	fn receive_complete_referendums(n: u32, ) -> Weight {
		...
		Weight::from_parts(1_710_526, 0)
			// Standard Error: 2_326
			.saturating_add(Weight::from_parts(1_297_596, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	}
	/// Storage: `Preimage::PreimageFor` (r:1 w:1)
	/// Proof: `Preimage::PreimageFor` (`max_values`: None, `max_size`: Some(4194344), added: 4196819, mode: `Measured`)
	...
	fn receive_single_scheduler_agenda(m: u32, ) -> Weight {
		...
		Weight::from_parts(8_000_000, 3609)
			// Standard Error: 11
			.saturating_add(Weight::from_parts(2_061, 0).saturating_mul(m.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
			.saturating_add(Weight::from_parts(0, 1).saturating_mul(m.into()))
	}
	...
	fn receive_scheduler_lookup(n: u32, ) -> Weight {
		...
		//  Estimated: `0`
		// Minimum execution time: 6_000_000 picoseconds.
		Weight::from_parts(2_183_634, 0)
			// Standard Error: 1_725
			.saturating_add(Weight::from_parts(1_063_381, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	}
	...
	fn receive_bags_list_messages(n: u32, ) -> Weight {
		...
		Weight::from_parts(7_120_540, 1489)
			// Standard Error: 23_898
			.saturating_add(Weight::from_parts(5_106_582, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes(1_u64))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	...
	fn receive_indices(n: u32, ) -> Weight {
		...
		// Minimum execution time: 8_000_000 picoseconds.
		Weight::from_parts(3_106_645, 990)
			// Standard Error: 4_225
			.saturating_add(Weight::from_parts(2_136_773, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	...
	fn receive_conviction_voting_messages(n: u32, ) -> Weight {
		...
		Weight::from_parts(27_000_000, 0)
			...
			.saturating_add(Weight::from_parts(20_979_825, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	}
	...
	fn receive_bounties_messages(n: u32, ) -> Weight {
		...
		//  Estimated: `0`
		// Minimum execution time: 6_000_000 picoseconds.
		Weight::from_parts(1_138_823, 0)
			// Standard Error: 3_365
			.saturating_add(Weight::from_parts(1_153_491, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	}
	...
	fn receive_asset_rates(n: u32, ) -> Weight {
		...
		//  Estimated: `0`
		// Minimum execution time: 7_000_000 picoseconds.
		Weight::from_parts(1_273_815, 0)
			// Standard Error: 4_753
			.saturating_add(Weight::from_parts(2_344_480, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	}
	...
	fn receive_crowdloan_messages(n: u32, ) -> Weight {
		...
		Weight::from_parts(13_000_000, 990)
			...
			.saturating_add(Weight::from_parts(5_727_767, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	...
	fn receive_referenda_metadata(n: u32, ) -> Weight {
		...
		//  Estimated: `0`
		// Minimum execution time: 6_000_000 picoseconds.
		Weight::from_parts(2_402_375, 0)
			// Standard Error: 3_536
			.saturating_add(Weight::from_parts(1_062_810, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	}
	...
	fn receive_treasury_messages(n: u32, ) -> Weight {
		...
		Weight::from_parts(10_000_000, 0)
			...
			.saturating_add(Weight::from_parts(4_223_710, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	}
	...
	fn receive_delegated_staking_messages(n: u32, ) -> Weight {
		...
		// Minimum execution time: 8_000_000 picoseconds.
		Weight::from_parts(13_843_776, 1489)
			// Standard Error: 11_181
			.saturating_add(Weight::from_parts(2_747_758, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes(1_u64))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	...
	fn receive_preimage_legacy_status(n: u32, ) -> Weight {
		...
		//  Estimated: `990 + n * (2603 ±0)`
		// Minimum execution time: 18_000_000 picoseconds.
		Weight::from_parts(10_625_373, 990)
			// Standard Error: 40_720
			.saturating_add(Weight::from_parts(12_936_485, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
			.saturating_add(Weight::from_parts(0, 2603).saturating_mul(n.into()))
	}
	...
	fn receive_preimage_request_status(n: u32, ) -> Weight {
		...
		// Minimum execution time: 8_000_000 picoseconds.
		Weight::from_parts(5_108_798, 990)
			// Standard Error: 7_204
			.saturating_add(Weight::from_parts(2_175_621, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
	...
	fn receive_preimage_chunk(m: u32, ) -> Weight {
		...
		Weight::from_parts(20_000_000, 3469)
			// Standard Error: 166_680
			.saturating_add(Weight::from_parts(29_230_197, 0).saturating_mul(m.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	...
	fn receive_child_bounties_messages(n: u32, ) -> Weight {
		...
		//  Estimated: `0`
		// Minimum execution time: 12_000_000 picoseconds.
		Weight::from_parts(5_050_951, 0)
			// Standard Error: 12_069
			.saturating_add(Weight::from_parts(7_103_819, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	}
	...
	fn start_migration() -> Weight {
		...
		Weight::from_parts(31_000_000, 4926)
