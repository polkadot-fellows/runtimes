...
impl<T: frame_system::Config> pallet_election_provider_multi_block::signed::WeightInfo for WeightInfo<T> {
	...
	fn register_eject() -> Weight {
		...
		//  Measured:  `8036`
		//  Estimated: `48626`
		// Minimum execution time: 175_981_000 picoseconds.
		Weight::from_parts(187_461_000, 0)
	...
	fn submit_page() -> Weight {
		...
		Weight::from_parts(231_231_000, 0)
	...
	fn unset_page() -> Weight {
		...
		//  Measured:  `18372`
		//  Estimated: `24312`
		// Minimum execution time: 180_581_000 picoseconds.
		Weight::from_parts(199_060_000, 0)
			.saturating_add(Weight::from_parts(0, 24312))
			.saturating_add(T::DbWeight::get().reads(9))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	/// Storage: `MultiBlockElection::CurrentPhase` (r:1 w:0)
	...
	fn bail() -> Weight {
		...
		Weight::from_parts(117_050_000, 0)
	...
	fn clear_old_round_data(p: u32, ) -> Weight {
		...
		// Minimum execution time: 71_360_000 picoseconds.
		Weight::from_parts(79_673_446, 0)
			.saturating_add(Weight::from_parts(0, 7098))
			// Standard Error: 51_570
			.saturating_add(Weight::from_parts(1_200_945, 0).saturating_mul(p.into()))
