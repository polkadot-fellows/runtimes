...
impl<T: frame_system::Config> pallet_election_provider_multi_block::signed::WeightInfo for WeightInfo<T> {
	...
	fn register_eject() -> Weight {
		...
		//  Measured:  `5620`
		//  Estimated: `46210`
		// Minimum execution time: 165_710_000 picoseconds.
		Weight::from_parts(177_011_000, 0)
			.saturating_add(Weight::from_parts(0, 46210))
	...
	fn submit_page() -> Weight {
		...
		//  Measured:  `2460`
		//  Estimated: `8400`
		// Minimum execution time: 193_560_000 picoseconds.
		Weight::from_parts(210_191_000, 0)
	...
	fn unset_page() -> Weight {
		...
		//  Measured:  `17126`
		//  Estimated: `23066`
		// Minimum execution time: 159_200_000 picoseconds.
		Weight::from_parts(185_570_000, 0)
			.saturating_add(Weight::from_parts(0, 23066))
			.saturating_add(T::DbWeight::get().reads(9))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	/// Storage: `MultiBlockElection::CurrentPhase` (r:1 w:0)
	...
	fn bail() -> Weight {
		...
		//  Measured:  `3017`
		//  Estimated: `43607`
		// Minimum execution time: 100_750_000 picoseconds.
		Weight::from_parts(113_050_000, 0)
			.saturating_add(Weight::from_parts(0, 43607))
	...
	fn clear_old_round_data(p: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `2388 + p * (40 ±0)`
		//  Estimated: `5852 + p * (2516 ±0)`
		// Minimum execution time: 65_270_000 picoseconds.
		Weight::from_parts(72_179_314, 0)
			.saturating_add(Weight::from_parts(0, 5852))
			// Standard Error: 78_821
			.saturating_add(Weight::from_parts(1_420_582, 0).saturating_mul(p.into()))
