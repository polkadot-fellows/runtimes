...
use assets_common::{
	...
	matching::FromSiblingParachain, AssetIdForTrustBackedAssetsConvert, MultiLocationForAssetId,
};
...
use xcm_config::{
	bridging::to_ethereum::EthereumLocation, FellowshipLocation, ForeignAssetsConvertedConcreteId,
	GovernanceLocation, KsmLocation, PoolAssetsConvertedConcreteId, TrustBackedAssetsConvertedConcreteId, XcmConfig,
};
...
impl pallet_xcm_bridge_hub_router::Config<ToEthereumXcmRouterInstance> for Runtime {
	...
	type BridgedNetworkId = snowbridge_kusama_common::EthereumNetwork;
