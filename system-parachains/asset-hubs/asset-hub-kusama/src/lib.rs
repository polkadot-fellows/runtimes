...
parameter_types! {
	...
	pub SessionKeyDeposit: Balance = kusama_runtime_constants::currency::deposit(1, SessionKeys::max_encoded_len() as u32)
		.saturating_add(kusama_runtime_constants::currency::deposit(
