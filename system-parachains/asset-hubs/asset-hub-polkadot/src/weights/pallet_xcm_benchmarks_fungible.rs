...
impl<T: frame_system::Config> pallet_xcm_benchmarks::fungible::WeightInfo for WeightInfo<T> {
	...
	fn transfer_reserve_asset() -> Weight {
		...
		//  Measured:  `176`
		//  Estimated: `6196`
		// Minimum execution time: 67_839_000 picoseconds.
		Weight::from_parts(69_023_000, 0)
			.saturating_add(Weight::from_parts(0, 6196))
	...
	fn initiate_reserve_withdraw() -> Weight {
		...
		//  Measured:  `75`
		//  Estimated: `3540`
		// Minimum execution time: 446_344_000 picoseconds.
		Weight::from_parts(462_514_000, 0)
	...
	fn initiate_teleport() -> Weight {
		...
		Weight::from_parts(30_776_000, 0)
			.saturating_add(Weight::from_parts(0, 3540))
			.saturating_add(T::DbWeight::get().reads(6))
			.saturating_add(T::DbWeight::get().writes(2))
	}
