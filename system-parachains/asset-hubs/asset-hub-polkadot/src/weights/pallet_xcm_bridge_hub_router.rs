...
impl<T: frame_system::Config> pallet_xcm_bridge_hub_router::WeightInfo for WeightInfo<T> {
	...
	/// Storage: `ToKusamaXcmRouter::DeliveryFeeFactor` (r:1 w:1)
	/// Proof: `ToKusamaXcmRouter::DeliveryFeeFactor` (`max_values`: Some(1), `max_size`: Some(16), added: 511, mode: `MaxEncodedLen`)
