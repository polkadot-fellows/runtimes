...
impl<T: frame_system::Config> pallet_ah_migrator::WeightInfo for WeightInfo<T> {
	...
	fn receive_multisigs(n: u32, ) -> Weight {
		...
		Weight::from_parts(21_314_166, 990)
			// Standard Error: 21_736
			.saturating_add(Weight::from_parts(12_230_738, 0).saturating_mul(n.into()))
	...
	fn receive_accounts(n: u32, ) -> Weight {
		...
		Weight::from_parts(80_000_000, 990)
			// Standard Error: 147_137
			.saturating_add(Weight::from_parts(81_693_519, 0).saturating_mul(n.into()))
	...
	fn receive_liquid_accounts(n: u32, ) -> Weight {
		...
		Weight::from_parts(26_000_000, 990)
			// Standard Error: 48_950
			.saturating_add(Weight::from_parts(21_149_419, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
			.saturating_add(Weight::from_parts(0, 2603).saturating_mul(n.into()))
	}
	...
	fn receive_claims(n: u32, ) -> Weight {
		...
		Weight::from_parts(4_675_874, 990)
			// Standard Error: 6_424
			.saturating_add(Weight::from_parts(1_836_607, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	...
	fn receive_proxy_proxies(n: u32, ) -> Weight {
		...
		Weight::from_parts(9_000_000, 990)
			...
			.saturating_add(Weight::from_parts(2_805_223, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	...
	fn receive_proxy_announcements(n: u32, ) -> Weight {
		...
		Weight::from_parts(16_980_741, 990)
			// Standard Error: 46_659
			.saturating_add(Weight::from_parts(13_538_701, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
			.saturating_add(Weight::from_parts(0, 2603).saturating_mul(n.into()))
	}
	...
	fn receive_vesting_schedules(n: u32, ) -> Weight {
		...
		Weight::from_parts(4_819_088, 990)
			// Standard Error: 3_456
			.saturating_add(Weight::from_parts(3_232_253, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
	...
	fn receive_nom_pools_messages(n: u32, ) -> Weight {
		...
		Weight::from_parts(1_109_438, 1489)
			// Standard Error: 5_630
			.saturating_add(Weight::from_parts(4_255_054, 0).saturating_mul(n.into()))
	...
	fn receive_single_active_referendums(m: u32, ) -> Weight {
		...
		Weight::from_parts(7_000_000, 3609)
			// Standard Error: 8
			.saturating_add(Weight::from_parts(1_939, 0).saturating_mul(m.into()))
	...
	fn receive_complete_referendums(n: u32, ) -> Weight {
		...
		//  Estimated: `0`
		// Minimum execution time: 6_000_000 picoseconds.
		Weight::from_parts(2_436_379, 0)
			// Standard Error: 2_197
			.saturating_add(Weight::from_parts(1_287_716, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	}
	/// Storage: `Preimage::PreimageFor` (r:1 w:1)
	/// Proof: `Preimage::PreimageFor` (`max_values`: None, `max_size`: Some(4194344), added: 4196819, mode: `Measured`)
	...
	fn receive_scheduler_lookup(n: u32, ) -> Weight {
		...
		//  Estimated: `0`
		// Minimum execution time: 6_000_000 picoseconds.
		Weight::from_parts(768_711, 0)
			// Standard Error: 12_508
			.saturating_add(Weight::from_parts(1_095_744, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	}
	...
	fn receive_bags_list_messages(n: u32, ) -> Weight {
		...
		Weight::from_parts(18_118_060, 1489)
			// Standard Error: 12_646
			.saturating_add(Weight::from_parts(4_970_968, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes(1_u64))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	...
	fn receive_indices(n: u32, ) -> Weight {
		...
		// Minimum execution time: 7_000_000 picoseconds.
		Weight::from_parts(1_484_671, 990)
			// Standard Error: 3_362
			.saturating_add(Weight::from_parts(2_085_440, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	...
	fn receive_conviction_voting_messages(n: u32, ) -> Weight {
		...
		Weight::from_parts(25_000_000, 0)
			// Standard Error: 52_012
			.saturating_add(Weight::from_parts(21_106_362, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	}
	...
	fn receive_bounties_messages(n: u32, ) -> Weight {
		...
		Weight::from_parts(800_150, 0)
			// Standard Error: 2_772
			.saturating_add(Weight::from_parts(1_148_665, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	}
	...
	fn receive_asset_rates(n: u32, ) -> Weight {
		...
		//  Estimated: `0`
		// Minimum execution time: 7_000_000 picoseconds.
		Weight::from_parts(876_970, 0)
			// Standard Error: 4_326
			.saturating_add(Weight::from_parts(2_313_260, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	}
	...
	fn receive_crowdloan_messages(n: u32, ) -> Weight {
		...
		Weight::from_parts(6_230_896, 990)
			// Standard Error: 5_909
			.saturating_add(Weight::from_parts(5_626_059, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	...
	fn receive_referenda_metadata(n: u32, ) -> Weight {
		...
		//  Estimated: `0`
		// Minimum execution time: 6_000_000 picoseconds.
		Weight::from_parts(2_859_258, 0)
			// Standard Error: 3_141
			.saturating_add(Weight::from_parts(1_061_407, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	}
	...
	fn receive_treasury_messages(n: u32, ) -> Weight {
		...
		//  Estimated: `0`
		// Minimum execution time: 8_000_000 picoseconds.
		Weight::from_parts(3_701_262, 0)
			// Standard Error: 6_336
			.saturating_add(Weight::from_parts(4_117_806, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	}
	...
	fn receive_delegated_staking_messages(n: u32, ) -> Weight {
		...
		Weight::from_parts(374_323, 1489)
			// Standard Error: 13_486
			.saturating_add(Weight::from_parts(2_756_004, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes(1_u64))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	...
	fn receive_preimage_legacy_status(n: u32, ) -> Weight {
		...
		//  Estimated: `990 + n * (2603 ±0)`
		// Minimum execution time: 18_000_000 picoseconds.
		Weight::from_parts(30_468_123, 990)
			// Standard Error: 13_719
			.saturating_add(Weight::from_parts(12_302_649, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
			.saturating_add(Weight::from_parts(0, 2603).saturating_mul(n.into()))
	}
	...
	fn receive_preimage_request_status(n: u32, ) -> Weight {
		...
		Weight::from_parts(8_000_000, 990)
			...
			.saturating_add(Weight::from_parts(2_242_551, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
	...
	fn receive_preimage_chunk(m: u32, ) -> Weight {
		...
		Weight::from_parts(21_000_000, 3469)
			// Standard Error: 153_402
			.saturating_add(Weight::from_parts(28_688_722, 0).saturating_mul(m.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	...
	fn receive_child_bounties_messages(n: u32, ) -> Weight {
		...
		Weight::from_parts(1_465_192, 0)
			// Standard Error: 25_042
			.saturating_add(Weight::from_parts(7_324_166, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	}
	...
	fn receive_staking_messages(n: u32, ) -> Weight {
		...
		//  Estimated: `0`
		// Minimum execution time: 10_000_000 picoseconds.
		Weight::from_parts(9_260_427, 0)
			// Standard Error: 50_508
