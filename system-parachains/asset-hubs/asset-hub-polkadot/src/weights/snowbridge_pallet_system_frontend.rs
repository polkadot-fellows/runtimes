...
impl<T: frame_system::Config> snowbridge_pallet_system_frontend::WeightInfo for WeightInfo<T> {
	...
	fn register_token() -> Weight {
		...
		//  Measured:  `3628`
		//  Estimated: `7556`
		// Minimum execution time: 149_181_000 picoseconds.
		Weight::from_parts(163_390_000, 0)
	...
	fn add_tip() -> Weight {
		...
		//  Measured:  `1950`
		//  Estimated: `7404`
		// Minimum execution time: 132_850_000 picoseconds.
		Weight::from_parts(142_111_000, 0)
