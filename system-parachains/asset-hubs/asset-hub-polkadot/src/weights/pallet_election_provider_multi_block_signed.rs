...
impl<T: frame_system::Config> pallet_election_provider_multi_block::signed::WeightInfo for WeightInfo<T> {
	...
	fn register_eject() -> Weight {
		...
		Weight::from_parts(154_101_000, 0)
	...
	fn submit_page() -> Weight {
		...
		Weight::from_parts(165_160_000, 0)
	...
	fn unset_page() -> Weight {
		...
		//  Measured:  `17466`
		//  Estimated: `23406`
		// Minimum execution time: 145_034_000 picoseconds.
	...
	fn bail() -> Weight {
		...
		//  Measured:  `4721`
		//  Estimated: `84911`
		// Minimum execution time: 88_784_000 picoseconds.
		Weight::from_parts(93_061_000, 0)
	...
	fn clear_old_round_data(p: u32, ) -> Weight {
		...
		Weight::from_parts(62_552_868, 0)
			.saturating_add(Weight::from_parts(0, 7178))
			// Standard Error: 3_794
			.saturating_add(Weight::from_parts(768_961, 0).saturating_mul(p.into()))
