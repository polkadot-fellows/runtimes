...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for WeightInfo<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(14_016_600, 0)
	...
	fn as_multi_create(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(42_706_640, 0)
			.saturating_add(Weight::from_parts(0, 6811))
			// Standard Error: 335
			.saturating_add(Weight::from_parts(81_341, 0).saturating_mul(s.into()))
			// Standard Error: 3
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(24_662_075, 0)
			.saturating_add(Weight::from_parts(0, 6811))
			// Standard Error: 239
			.saturating_add(Weight::from_parts(73_933, 0).saturating_mul(s.into()))
			// Standard Error: 2
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(45_836_480, 0)
			.saturating_add(Weight::from_parts(0, 6811))
			// Standard Error: 471
	...
	fn approve_as_multi_create(s: u32, ) -> Weight {
		...
		Weight::from_parts(41_113_307, 0)
			.saturating_add(Weight::from_parts(0, 6811))
			// Standard Error: 487
			.saturating_add(Weight::from_parts(81_953, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, ) -> Weight {
		...
		Weight::from_parts(23_340_332, 0)
			.saturating_add(Weight::from_parts(0, 6811))
			// Standard Error: 394
			.saturating_add(Weight::from_parts(74_419, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, ) -> Weight {
		...
		Weight::from_parts(41_632_995, 0)
			.saturating_add(Weight::from_parts(0, 6811))
			// Standard Error: 464
			.saturating_add(Weight::from_parts(80_618, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
