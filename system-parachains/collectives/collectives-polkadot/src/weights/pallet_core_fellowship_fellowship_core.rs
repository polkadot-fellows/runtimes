...
impl<T: frame_system::Config> pallet_core_fellowship::WeightInfo for WeightInfo<T> {
	...
	fn bump_demote() -> Weight {
		...
		Weight::from_parts(119_470_000, 0)
			.saturating_add(Weight::from_parts(0, 69046))
			.saturating_add(T::DbWeight::get().reads(6))
			.saturating_add(T::DbWeight::get().writes(6))
	}
	...
	fn promote() -> Weight {
		...
		Weight::from_parts(106_511_000, 0)
			.saturating_add(Weight::from_parts(0, 69046))
	...
	fn promote_fast(r: u32, ) -> Weight {
		...
		Weight::from_parts(105_063_264, 0)
			.saturating_add(Weight::from_parts(0, 69046))
			// Standard Error: 171_553
			.saturating_add(Weight::from_parts(15_183_524, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(3))
	...
	fn approve() -> Weight {
		...
		Weight::from_parts(92_750_000, 0)
			.saturating_add(Weight::from_parts(0, 69046))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(2))
	}
