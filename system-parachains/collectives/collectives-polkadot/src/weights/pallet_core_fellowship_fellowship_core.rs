...
impl<T: frame_system::Config> pallet_core_fellowship::WeightInfo for WeightInfo<T> {
	...
	fn bump_offboard() -> Weight {
		...
		Weight::from_parts(112_010_000, 0)
	...
	fn bump_demote() -> Weight {
		...
		//  Measured:  `66822`
		//  Estimated: `69046`
		// Minimum execution time: 110_500_000 picoseconds.
		Weight::from_parts(117_290_000, 0)
			.saturating_add(Weight::from_parts(0, 69046))
			.saturating_add(T::DbWeight::get().reads(6))
			.saturating_add(T::DbWeight::get().writes(6))
	}
	...
	fn promote() -> Weight {
		...
		//  Measured:  `66062`
		//  Estimated: `69046`
		// Minimum execution time: 97_089_000 picoseconds.
		Weight::from_parts(104_160_000, 0)
			.saturating_add(Weight::from_parts(0, 69046))
	...
	fn promote_fast(r: u32, ) -> Weight {
		...
		Weight::from_parts(85_075_367, 0)
			.saturating_add(Weight::from_parts(0, 69046))
			// Standard Error: 37_684
			.saturating_add(Weight::from_parts(16_961_745, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(3))
