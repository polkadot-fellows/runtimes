...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for WeightInfo<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(13_615_903, 0)
	...
	fn as_multi_create(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(35_917_254, 0)
			.saturating_add(Weight::from_parts(0, 6811))
			// Standard Error: 317
			.saturating_add(Weight::from_parts(81_440, 0).saturating_mul(s.into()))
			// Standard Error: 3
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(20_742_825, 0)
			.saturating_add(Weight::from_parts(0, 6811))
			// Standard Error: 298
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(38_751_622, 0)
			.saturating_add(Weight::from_parts(0, 6811))
			// Standard Error: 365
			.saturating_add(Weight::from_parts(108_402, 0).saturating_mul(s.into()))
			// Standard Error: 3
	...
	fn approve_as_multi_create(s: u32, ) -> Weight {
		...
		Weight::from_parts(33_950_608, 0)
			.saturating_add(Weight::from_parts(0, 6811))
			// Standard Error: 450
			.saturating_add(Weight::from_parts(85_920, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, ) -> Weight {
		...
		Weight::from_parts(19_043_458, 0)
			.saturating_add(Weight::from_parts(0, 6811))
			// Standard Error: 422
			.saturating_add(Weight::from_parts(81_439, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, ) -> Weight {
		...
		Weight::from_parts(34_491_786, 0)
			.saturating_add(Weight::from_parts(0, 6811))
			// Standard Error: 476
			.saturating_add(Weight::from_parts(83_107, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
