...
impl<T: frame_system::Config> pallet_encointer_democracy::WeightInfo for WeightInfo<T> {
	...
	/// Proof: `EncointerDemocracy::EnactmentQueue` (`max_values`: None, `max_size`: Some(2077), added: 4552, mode: `MaxEncodedLen`)
	...
	fn submit_proposal() -> Weight {
		...
		Weight::from_parts(38_529_000, 0)
	...
	fn vote() -> Weight {
		...
		//  Measured:  `1138`
		//  Estimated: `9553`
		// Minimum execution time: 96_180_000 picoseconds.
		Weight::from_parts(99_213_000, 0)
	...
	/// Proof: `EncointerDemocracy::Tallies` (`max_values`: None, `max_size`: Some(64), added: 2539, mode: `MaxEncodedLen`)
	/// Storage: `EncointerDemocracy::EnactmentQueue` (r:1 w:1)
	/// Proof: `EncointerDemocracy::EnactmentQueue` (`max_values`: None, `max_size`: Some(2077), added: 4552, mode: `MaxEncodedLen`)
	fn update_proposal_state() -> Weight {
		...
		Weight::from_parts(35_040_000, 0)
			.saturating_add(Weight::from_parts(0, 5542))
