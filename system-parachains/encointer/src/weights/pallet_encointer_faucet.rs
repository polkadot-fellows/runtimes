...
impl<T: frame_system::Config> pallet_encointer_faucet::WeightInfo for WeightInfo<T> {
	...
	fn create_faucet() -> Weight {
		...
		Weight::from_parts(71_274_000, 0)
	...
	fn drip() -> Weight {
		...
		Weight::from_parts(57_141_000, 0)
	...
	fn dissolve_faucet() -> Weight {
		...
		//  Measured:  `739`
		//  Estimated: `12838`
		// Minimum execution time: 63_044_000 picoseconds.
		Weight::from_parts(64_906_000, 0)
			.saturating_add(Weight::from_parts(0, 12838))
	...
	fn close_faucet() -> Weight {
		...
		Weight::from_parts(64_457_000, 0)
			.saturating_add(Weight::from_parts(0, 12838))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(5))
	}
