...
impl<T: frame_system::Config> pallet_encointer_reputation_rings::WeightInfo for WeightInfo<T> {
	...
	fn continue_ring_computation_collect(n: u32, ) -> Weight {
		...
		Weight::from_parts(88_310_000, 0)
			...
			// Standard Error: 25_210
			.saturating_add(Weight::from_parts(8_589_362, 0).saturating_mul(n.into()))
	...
	fn continue_ring_computation_build(n: u32, ) -> Weight {
		...
		Weight::from_parts(56_981_000, 0)
			.saturating_add(Weight::from_parts(0, 1568))
			// Standard Error: 14_533
			.saturating_add(Weight::from_parts(4_011_609, 0).saturating_mul(n.into()))
