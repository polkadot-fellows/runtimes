...
//! HOSTNAME: `dddfbe730295`, CPU: `QEMU Virtual CPU version 2.5+`
...
impl<T: frame_system::Config> pallet_bridge_messages::WeightInfo for WeightInfo<T> {
	...
	fn receive_n_messages_proof(n: u32, ) -> Weight {
		...
		Weight::from_parts(285_340_594, 0)
			.saturating_add(Weight::from_parts(0, 52645))
			// Standard Error: 45_362
			.saturating_add(Weight::from_parts(9_255_258, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(7))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `BridgeKusamaMessages::PalletOperatingMode` (r:1 w:0)
	...
	fn receive_single_n_bytes_message_proof(n: u32, ) -> Weight {
		...
		Weight::from_parts(42_180_577, 0)
			.saturating_add(Weight::from_parts(0, 52645))
			// Standard Error: 56
	...
	fn receive_single_n_bytes_message_proof_with_dispatch(n: u32, ) -> Weight {
		...
		Weight::from_parts(63_999_010, 0)
			.saturating_add(Weight::from_parts(0, 52645))
			// Standard Error: 22
			.saturating_add(Weight::from_parts(4_542, 0).saturating_mul(n.into()))
