...
//!
//! NOTE: copied verbatim from Asset Hub Polkadot as a placeholder for the liquidity-token
//! instance. They must be regenerated against the People Polkadot runtime.
//!
