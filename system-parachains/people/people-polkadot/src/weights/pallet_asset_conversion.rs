...
//!
//! NOTE: copied verbatim from Asset Hub Polkadot as a placeholder. The pallet is configured
//! identically on both chains, so these are the right order of magnitude, but they must be
//! regenerated against the People Polkadot runtime.
//!
