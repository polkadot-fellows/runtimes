...
//! `/cmd bench --runtime people-polkadot --pallet pallet_asset_conversion_tx_payment`
//! `charge_asset_tx_payment_asset` in particular under-accounts: People's `ChargeCheaper` quotes
//! both the pool and the rate before it charges, which is more work than the bare
//! `SwapAssetAdapter` this was measured with.
//!
...
impl<T: frame_system::Config> pallet_asset_conversion_tx_payment::WeightInfo for WeightInfo<T> {
	...
	fn charge_asset_tx_payment_asset() -> Weight {
		...
		//  Measured:  `3189`
		//  Estimated: `7404`
		// Minimum execution time: 99_838_000 picoseconds.
		Weight::from_parts(103_911_000, 0)
