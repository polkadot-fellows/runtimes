...
impl<T: frame_system::Config> indiv_pallet_game::WeightInfo for WeightInfo<T> {
	...
	/// Storage: `System::Account` (r:1 w:1)
	/// Proof: `System::Account` (`max_values`: None, `max_size`: Some(128), added: 2603, mode: `MaxEncodedLen`)
	/// Storage: `Game::AttestationNftCollection` (r:0 w:1)
	/// Proof: `Game::AttestationNftCollection` (`max_values`: Some(1), `max_size`: Some(4), added: 499, mode: `MaxEncodedLen`)
	...
	fn create_attestation_collection() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `107`
		//  Estimated: `3593`
	...
	/// Storage: `Game::AttestationNftCollection` (r:1 w:0)
	/// Proof: `Game::AttestationNftCollection` (`max_values`: Some(1), `max_size`: Some(4), added: 499, mode: `MaxEncodedLen`)
	fn authorize_create_attestation_collection() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `109`
		//  Estimated: `1489`
	...
	/// Storage: `Game::AttestationNftCollection` (r:1 w:0)
	/// Proof: `Game::AttestationNftCollection` (`max_values`: Some(1), `max_size`: Some(4), added: 499, mode: `MaxEncodedLen`)
	/// Storage: `Game::Nfts` (r:1 w:0)
	/// Proof: `Game::Nfts` (`max_values`: None, `max_size`: Some(101), added: 2576, mode: `MaxEncodedLen`)
	/// Storage: `Game::MintedNfts` (r:1 w:1)
	/// Proof: `Game::MintedNfts` (`max_values`: None, `max_size`: Some(52), added: 2527, mode: `MaxEncodedLen`)
	/// Storage: `Game::NextNftItemId` (r:1 w:1)
	/// Proof: `Game::NextNftItemId` (`max_values`: Some(1), `max_size`: Some(4), added: 499, mode: `MaxEncodedLen`)
	...
	fn mint_attestation_nft() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `687`
		//  Estimated: `4326`
	...
	fn set_attestation_nft_metadata(d: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `784`
		//  Estimated: `4326`
		// Minimum execution time: 22_443_000 picoseconds.
		Weight::from_parts(23_603_003, 0)
			.saturating_add(Weight::from_parts(0, 4326))
			// Standard Error: 112
			.saturating_add(Weight::from_parts(1_143, 0).saturating_mul(d.into()))
			.saturating_add(T::DbWeight::get().reads(6))
			.saturating_add(T::DbWeight::get().writes(2))
	}
}
