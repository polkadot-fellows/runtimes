...
#[derive(Encode, DecodeWithMemTracking, Decode, MaxEncodedLen, TypeInfo, RuntimeDebug, Clone, PartialEq, Eq)]
...
pub mod alias {
	...
	#[derive(
		Clone, Copy, PartialEq, Eq, Encode, DecodeWithMemTracking, Decode, Default, RuntimeDebug, TypeInfo, MaxEncodedLen,
	)]
	...
	#[derive(Encode, DecodeWithMemTracking, Decode, Clone, Copy, Eq, PartialEq, RuntimeDebug, TypeInfo, MaxEncodedLen)]
