...
impl<T: frame_system::Config> runtime_parachains::coretime::WeightInfo for WeightInfo<T> {
	...
	fn request_revenue_at() -> Weight {
		...
		//  Measured:  `2983`
		//  Estimated: `6448`
		// Minimum execution time: 120_740_000 picoseconds.
		Weight::from_parts(124_911_000, 0)
	...
	fn assign_core(s: u32, ) -> Weight {
		...
		Weight::from_parts(15_202_438, 0)
			.saturating_add(Weight::from_parts(0, 3545))
			// Standard Error: 698
			.saturating_add(Weight::from_parts(13_467, 0).saturating_mul(s.into()))
