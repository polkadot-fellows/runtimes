...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Measured:  `1506 + c * (15992 ±0) + h * (92 ±0) + u * (65723 ±0)`
		//  Estimated: `69051 + c * (17748 ±492) + h * (15057 ±681) + u * (41474 ±681)`
		// Minimum execution time: 573_244_000 picoseconds.
		Weight::from_parts(114_100_622, 0)
			.saturating_add(Weight::from_parts(0, 69051))
			// Standard Error: 617_253
			.saturating_add(Weight::from_parts(210_903_259, 0).saturating_mul(u.into()))
			// Standard Error: 617_253
			.saturating_add(Weight::from_parts(256_002_021, 0).saturating_mul(h.into()))
			// Standard Error: 1_022_862
			.saturating_add(Weight::from_parts(46_998_111, 0).saturating_mul(c.into()))
