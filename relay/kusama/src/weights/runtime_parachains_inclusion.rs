...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Measured:  `1378 + c * (15992 ±0) + h * (92 ±0) + u * (65724 ±0)`
		//  Estimated: `69051 + c * (17747 ±492) + h * (15058 ±681) + u * (41475 ±267)`
		// Minimum execution time: 572_628_000 picoseconds.
		Weight::from_parts(128_762_980, 0)
			.saturating_add(Weight::from_parts(0, 69051))
			// Standard Error: 1_044_246
			.saturating_add(Weight::from_parts(199_239_316, 0).saturating_mul(u.into()))
			// Standard Error: 1_044_246
			.saturating_add(Weight::from_parts(243_365_653, 0).saturating_mul(h.into()))
			// Standard Error: 1_730_441
			.saturating_add(Weight::from_parts(63_819_505, 0).saturating_mul(c.into()))
			...
			.saturating_add(Weight::from_parts(0, 17747).saturating_mul(c.into()))
