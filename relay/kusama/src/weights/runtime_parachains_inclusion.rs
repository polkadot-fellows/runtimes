...
//! HOSTNAME: `a0257f1ab3fe`, CPU: `QEMU Virtual CPU version 2.5+`
...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 580_150_000 picoseconds.
		Weight::from_parts(120_773_201, 0)
			.saturating_add(Weight::from_parts(0, 69051))
			// Standard Error: 1_072_473
			.saturating_add(Weight::from_parts(203_652_730, 0).saturating_mul(u.into()))
			// Standard Error: 1_072_473
			.saturating_add(Weight::from_parts(249_627_199, 0).saturating_mul(h.into()))
			// Standard Error: 1_777_217
			.saturating_add(Weight::from_parts(70_107_713, 0).saturating_mul(c.into()))
