...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Measured:  `67261 + c * (15992 ±0) + h * (75 ±0)`
		//  Estimated: `70725 + c * (43359 ±0) + h * (2551 ±0)`
		// Minimum execution time: 7_650_450_000 picoseconds.
		Weight::from_parts(1_567_213_345, 0)
			.saturating_add(Weight::from_parts(0, 70725))
			// Standard Error: 718_878
			.saturating_add(Weight::from_parts(217_391_080, 0).saturating_mul(u.into()))
			// Standard Error: 718_878
			.saturating_add(Weight::from_parts(274_408_333, 0).saturating_mul(h.into()))
			...
			.saturating_add(Weight::from_parts(0, 43359).saturating_mul(c.into()))
