...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `69051 + c * (17747 ±492) + h * (15058 ±681) + u * (41475 ±681)`
		// Minimum execution time: 576_408_000 picoseconds.
		Weight::from_parts(116_457_162, 0)
			.saturating_add(Weight::from_parts(0, 69051))
			// Standard Error: 963_647
			.saturating_add(Weight::from_parts(203_706_798, 0).saturating_mul(u.into()))
			// Standard Error: 963_647
			.saturating_add(Weight::from_parts(247_965_967, 0).saturating_mul(h.into()))
			// Standard Error: 1_596_878
			.saturating_add(Weight::from_parts(68_147_876, 0).saturating_mul(c.into()))
