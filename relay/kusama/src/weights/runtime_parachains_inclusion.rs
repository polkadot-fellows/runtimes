...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn receive_upward_messages(i: u32, ) -> Weight {
		...
		//  Measured:  `65761`
		//  Estimated: `69051`
		// Minimum execution time: 105_891_000 picoseconds.
		Weight::from_parts(106_141_000, 0)
			.saturating_add(Weight::from_parts(0, 69051))
			// Standard Error: 123_112
			.saturating_add(Weight::from_parts(91_012_522, 0).saturating_mul(i.into()))
