...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `69051 + c * (17549 ±0) + h * (12165 ±0) + u * (38781 ±0)`
		// Minimum execution time: 376_165_000 picoseconds.
		Weight::from_parts(40_482_007, 0)
			.saturating_add(Weight::from_parts(0, 69051))
			// Standard Error: 670_484
			.saturating_add(Weight::from_parts(147_372_387, 0).saturating_mul(u.into()))
			// Standard Error: 670_484
			.saturating_add(Weight::from_parts(178_722_688, 0).saturating_mul(h.into()))
			// Standard Error: 1_111_072
			.saturating_add(Weight::from_parts(42_650_530, 0).saturating_mul(c.into()))
