...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Measured:  `1477 + c * (15993 ±0) + h * (92 ±0) + u * (65724 ±0)`
		//  Estimated: `69051 + c * (17748 ±492) + h * (15058 ±681) + u * (41475 ±267)`
		// Minimum execution time: 582_620_000 picoseconds.
		Weight::from_parts(133_100_479, 0)
			.saturating_add(Weight::from_parts(0, 69051))
			// Standard Error: 967_830
			.saturating_add(Weight::from_parts(199_139_167, 0).saturating_mul(u.into()))
			// Standard Error: 967_830
			.saturating_add(Weight::from_parts(243_307_352, 0).saturating_mul(h.into()))
			// Standard Error: 1_603_810
			.saturating_add(Weight::from_parts(65_648_960, 0).saturating_mul(c.into()))
