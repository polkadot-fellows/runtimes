...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn receive_upward_messages(i: u32, ) -> Weight {
		...
		//  Measured:  `65761`
		//  Estimated: `69051`
		// Minimum execution time: 120_123_000 picoseconds.
		Weight::from_parts(120_613_000, 0)
			.saturating_add(Weight::from_parts(0, 69051))
			// Standard Error: 120_621
			.saturating_add(Weight::from_parts(107_015_340, 0).saturating_mul(i.into()))
