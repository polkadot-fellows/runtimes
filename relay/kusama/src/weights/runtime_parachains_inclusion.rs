...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Measured:  `1469 + c * (15992 ±0) + h * (92 ±0) + u * (65724 ±0)`
		//  Estimated: `69051 + c * (17747 ±492) + h * (15058 ±681) + u * (41475 ±681)`
		// Minimum execution time: 594_794_000 picoseconds.
		Weight::from_parts(141_311_989, 0)
			.saturating_add(Weight::from_parts(0, 69051))
			// Standard Error: 463_034
			.saturating_add(Weight::from_parts(217_218_653, 0).saturating_mul(u.into()))
			// Standard Error: 463_034
			.saturating_add(Weight::from_parts(248_510_409, 0).saturating_mul(h.into()))
			// Standard Error: 767_303
			.saturating_add(Weight::from_parts(31_636_376, 0).saturating_mul(c.into()))
