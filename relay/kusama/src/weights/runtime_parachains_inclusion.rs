...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Measured:  `1440 + c * (15992 ±0) + h * (92 ±0) + u * (65723 ±0)`
		//  Estimated: `69051 + c * (17549 ±3_679) + h * (12165 ±2_993) + u * (38781 ±2_993)`
		// Minimum execution time: 427_082_000 picoseconds.
		Weight::from_parts(44_270_799, 0)
			.saturating_add(Weight::from_parts(0, 69051))
			// Standard Error: 710_638
			.saturating_add(Weight::from_parts(171_081_192, 0).saturating_mul(u.into()))
			// Standard Error: 710_638
			.saturating_add(Weight::from_parts(212_331_530, 0).saturating_mul(h.into()))
			// Standard Error: 1_177_612
			.saturating_add(Weight::from_parts(49_348_880, 0).saturating_mul(c.into()))
