...
impl<T: frame_system::Config> runtime_parachains::disputes::slashing::WeightInfo for WeightInfo<T> {
	...
	fn report_dispute_lost_unsigned(n: u32, ) -> Weight {
		...
		//  Measured:  `2216 + n * (32 ±0)`
		//  Estimated: `5630 + n * (33 ±0)`
		// Minimum execution time: 151_321_000 picoseconds.
		Weight::from_parts(190_869_093, 0)
			.saturating_add(Weight::from_parts(0, 5630))
			// Standard Error: 2_226
			.saturating_add(Weight::from_parts(138_870, 0).saturating_mul(n.into()))
