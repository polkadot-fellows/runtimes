...
impl<T: frame_system::Config> runtime_parachains::disputes::slashing::WeightInfo for WeightInfo<T> {
	...
	fn report_dispute_lost(n: u32, ) -> Weight {
		...
		//  Measured:  `6086 + n * (250 ±0)`
		//  Estimated: `9266 + n * (254 ±0)`
		// Minimum execution time: 100_325_000 picoseconds.
		Weight::from_parts(149_227_851, 0)
			.saturating_add(Weight::from_parts(0, 9266))
			// Standard Error: 3_096
			.saturating_add(Weight::from_parts(380_082, 0).saturating_mul(n.into()))
