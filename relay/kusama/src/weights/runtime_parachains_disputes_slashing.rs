...
impl<T: frame_system::Config> runtime_parachains::disputes::slashing::WeightInfo for WeightInfo<T> {
	...
	fn report_dispute_lost(n: u32, ) -> Weight {
		...
		//  Estimated: `8877 + n * (835 ±0)`
		// Minimum execution time: 79_000_000 picoseconds.
		Weight::from_parts(158_126_221, 0)
			.saturating_add(Weight::from_parts(0, 8877))
			// Standard Error: 2_455
			.saturating_add(Weight::from_parts(191_196, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(23))
			.saturating_add(T::DbWeight::get().writes(15))
			.saturating_add(Weight::from_parts(0, 835).saturating_mul(n.into()))
	}
}
