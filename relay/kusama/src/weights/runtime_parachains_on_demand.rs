...
impl<T: frame_system::Config> runtime_parachains::on_demand::WeightInfo for WeightInfo<T> {
	...
	fn place_order_keep_alive(s: u32, ) -> Weight {
		...
		Weight::from_parts(70_656_561, 0)
			.saturating_add(Weight::from_parts(0, 3700))
			// Standard Error: 115
			.saturating_add(Weight::from_parts(17_485, 0).saturating_mul(s.into()))
	...
	fn place_order_allow_death(s: u32, ) -> Weight {
		...
		Weight::from_parts(69_606_787, 0)
			.saturating_add(Weight::from_parts(0, 3700))
			// Standard Error: 112
	...
	fn place_order_with_credits(s: u32, ) -> Weight {
		...
		Weight::from_parts(39_946_902, 0)
			.saturating_add(Weight::from_parts(0, 3734))
			// Standard Error: 85
			.saturating_add(Weight::from_parts(16_733, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(4))
			.saturating_add(Weight::from_parts(0, 8).saturating_mul(s.into()))
	}
