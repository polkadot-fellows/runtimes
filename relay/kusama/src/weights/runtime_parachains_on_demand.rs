...
impl<T: frame_system::Config> runtime_parachains::on_demand::WeightInfo for WeightInfo<T> {
	...
	fn place_order_keep_alive(s: u32, ) -> Weight {
		...
		// Minimum execution time: 53_411_000 picoseconds.
		Weight::from_parts(43_604_060, 0)
			.saturating_add(Weight::from_parts(0, 3700))
			// Standard Error: 115
			.saturating_add(Weight::from_parts(20_893, 0).saturating_mul(s.into()))
	...
	fn place_order_allow_death(s: u32, ) -> Weight {
		...
		Weight::from_parts(42_225_642, 0)
			.saturating_add(Weight::from_parts(0, 3700))
			// Standard Error: 111
			.saturating_add(Weight::from_parts(20_913, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(4))
			.saturating_add(Weight::from_parts(0, 8).saturating_mul(s.into()))
	}
