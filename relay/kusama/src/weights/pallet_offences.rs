...
impl<T: frame_system::Config> pallet_offences::WeightInfo for WeightInfo<T> {
	...
	fn report_offence_grandpa(n: u32, ) -> Weight {
		...
		Weight::from_parts(60_670_125, 0)
			.saturating_add(Weight::from_parts(0, 4812))
			// Standard Error: 15_058
			.saturating_add(Weight::from_parts(8_682_219, 0).saturating_mul(n.into()))
	...
	fn report_offence_babe(n: u32, ) -> Weight {
		...
		Weight::from_parts(61_106_779, 0)
			.saturating_add(Weight::from_parts(0, 4812))
			// Standard Error: 16_890
			.saturating_add(Weight::from_parts(8_668_934, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(15))
			.saturating_add(T::DbWeight::get().reads((3_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes(6))
			.saturating_add(T::DbWeight::get().writes((3_u64).saturating_mul(n.into())))
