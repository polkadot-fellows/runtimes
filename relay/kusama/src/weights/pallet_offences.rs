...
impl<T: frame_system::Config> pallet_offences::WeightInfo for WeightInfo<T> {
	...
	fn report_offence_grandpa(n: u32, ) -> Weight {
		...
		//  Measured:  `1022`
		//  Estimated: `4475 + n * (2551 ±0)`
		// Minimum execution time: 72_890_000 picoseconds.
		Weight::from_parts(76_873_709, 0)
			.saturating_add(Weight::from_parts(0, 4475))
			// Standard Error: 8_535
			.saturating_add(Weight::from_parts(13_580_394, 0).saturating_mul(n.into()))
	...
	fn report_offence_babe(n: u32, ) -> Weight {
		...
		Weight::from_parts(76_116_205, 0)
			.saturating_add(Weight::from_parts(0, 4475))
			// Standard Error: 8_222
			.saturating_add(Weight::from_parts(13_573_770, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(12))
			.saturating_add(T::DbWeight::get().reads((3_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes(7))
			.saturating_add(T::DbWeight::get().writes((3_u64).saturating_mul(n.into())))
