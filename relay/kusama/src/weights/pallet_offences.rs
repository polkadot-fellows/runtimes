...
impl<T: frame_system::Config> pallet_offences::WeightInfo for WeightInfo<T> {
	...
	fn report_offence_grandpa(n: u32, ) -> Weight {
		...
		//  Measured:  `1247 + n * (39 ±0)`
		//  Estimated: `4712 + n * (2551 ±0)`
		// Minimum execution time: 81_260_000 picoseconds.
		Weight::from_parts(96_705_163, 0)
			.saturating_add(Weight::from_parts(0, 4712))
			// Standard Error: 42_170
			.saturating_add(Weight::from_parts(16_912_715, 0).saturating_mul(n.into()))
	...
	fn report_offence_babe(n: u32, ) -> Weight {
		...
		Weight::from_parts(98_375_442, 0)
			.saturating_add(Weight::from_parts(0, 4712))
			// Standard Error: 50_466
			.saturating_add(Weight::from_parts(16_796_760, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(14))
			.saturating_add(T::DbWeight::get().reads((3_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes(6))
			.saturating_add(T::DbWeight::get().writes((3_u64).saturating_mul(n.into())))
