...
// TODO: XCMv2 is now discontinued. Should we keep this test?
// #[test]
...
// 	let blob =
// hex_literal::hex!("
// 02140004000000000700e40b540213000000000700e40b54020006010700c817a804341801000006010b00c490bf4302140d010003ffffffff000100411f"
// ); 	#[allow(deprecated)] // `xcm::v2` is deprecated
// 	let Ok(VersionedXcm::V2(old_xcm_v2)) = VersionedXcm::<super::RuntimeCall>::decode(&mut
// &blob[..]) else { 		panic!("can't decode XCM blob")
// 	};
