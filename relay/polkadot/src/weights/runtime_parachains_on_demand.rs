...
impl<T: frame_system::Config> runtime_parachains::on_demand::WeightInfo for WeightInfo<T> {
	...
	fn place_order_allow_death() -> Weight {
		...
		//  Measured:  `80095`
		//  Estimated: `81580`
		// Minimum execution time: 125_540_000 picoseconds.
		Weight::from_parts(151_950_000, 0)
			.saturating_add(Weight::from_parts(0, 81580))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	...
	fn place_order_with_credits() -> Weight {
		...
		//  Measured:  `80129`
		//  Estimated: `83594`
		// Minimum execution time: 110_880_000 picoseconds.
		Weight::from_parts(128_750_000, 0)
