...
impl<T: frame_system::Config> runtime_parachains::coretime::WeightInfo for WeightInfo<T> {
	...
	fn request_revenue_at() -> Weight {
		...
		//  Measured:  `2912`
		//  Estimated: `6377`
		// Minimum execution time: 148_409_000 picoseconds.
		Weight::from_parts(193_660_000, 0)
	...
	fn assign_core(s: u32, ) -> Weight {
		...
		Weight::from_parts(17_015_832, 0)
			.saturating_add(Weight::from_parts(0, 3579))
			// Standard Error: 5_516
			.saturating_add(Weight::from_parts(62_534, 0).saturating_mul(s.into()))
