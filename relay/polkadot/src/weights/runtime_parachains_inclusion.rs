...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Measured:  `1472 + c * (15992 ±0) + h * (92 ±0) + u * (65723 ±0)`
		//  Estimated: `69051 + c * (17549 ±3_679) + h * (12165 ±2_993) + u * (38781 ±2_993)`
		// Minimum execution time: 512_720_000 picoseconds.
		Weight::from_parts(70_978_756, 0)
			.saturating_add(Weight::from_parts(0, 69051))
			// Standard Error: 1_077_252
			.saturating_add(Weight::from_parts(204_592_885, 0).saturating_mul(u.into()))
			// Standard Error: 1_077_252
			.saturating_add(Weight::from_parts(238_746_470, 0).saturating_mul(h.into()))
			// Standard Error: 1_785_135
			.saturating_add(Weight::from_parts(54_142_020, 0).saturating_mul(c.into()))
			...
			.saturating_add(Weight::from_parts(0, 17549).saturating_mul(c.into()))
			.saturating_add(Weight::from_parts(0, 12165).saturating_mul(h.into()))
			.saturating_add(Weight::from_parts(0, 38781).saturating_mul(u.into()))
	}
}
