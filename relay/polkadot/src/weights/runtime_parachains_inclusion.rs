...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Measured:  `1473 + c * (15992 ±0) + h * (92 ±0) + u * (65723 ±0)`
		//  Estimated: `69051 + c * (17549 ±2_185) + h * (12165 ±2_993) + u * (38781 ±1_186)`
		// Minimum execution time: 517_391_000 picoseconds.
		Weight::from_parts(55_193_451, 0)
			.saturating_add(Weight::from_parts(0, 69051))
			// Standard Error: 850_856
			.saturating_add(Weight::from_parts(207_167_086, 0).saturating_mul(u.into()))
			// Standard Error: 850_856
			.saturating_add(Weight::from_parts(256_031_044, 0).saturating_mul(h.into()))
			// Standard Error: 1_409_971
			.saturating_add(Weight::from_parts(57_171_712, 0).saturating_mul(c.into()))
