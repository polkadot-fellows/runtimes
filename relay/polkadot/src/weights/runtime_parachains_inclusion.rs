...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `69051 + c * (17549 ±3_000) + h * (12165 ±0) + u * (38781 ±1_737)`
		// Minimum execution time: 489_700_000 picoseconds.
		Weight::from_parts(67_352_763, 0)
			.saturating_add(Weight::from_parts(0, 69051))
			// Standard Error: 1_891_889
			.saturating_add(Weight::from_parts(204_604_193, 0).saturating_mul(u.into()))
			// Standard Error: 1_891_889
			.saturating_add(Weight::from_parts(240_889_905, 0).saturating_mul(h.into()))
			// Standard Error: 3_135_087
			.saturating_add(Weight::from_parts(68_559_799, 0).saturating_mul(c.into()))
