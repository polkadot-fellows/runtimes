...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `69051 + c * (17748 ±0) + h * (15057 ±681) + u * (41474 ±681)`
		// Minimum execution time: 578_609_000 picoseconds.
		Weight::from_parts(119_293_317, 0)
			.saturating_add(Weight::from_parts(0, 69051))
			// Standard Error: 947_964
			.saturating_add(Weight::from_parts(206_535_054, 0).saturating_mul(u.into()))
			// Standard Error: 947_964
			.saturating_add(Weight::from_parts(248_030_325, 0).saturating_mul(h.into()))
			// Standard Error: 1_570_890
			.saturating_add(Weight::from_parts(60_188_239, 0).saturating_mul(c.into()))
