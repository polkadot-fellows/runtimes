...
impl<T: frame_system::Config> polkadot_runtime_common::identity_migrator::WeightInfo for WeightInfo<T> {
	...
	fn reap_identity(r: u32, s: u32, ) -> Weight {
		...
		//  Measured:  `7522 + r * (5 ±0) + s * (32 ±0)`
		//  Estimated: `11037 + r * (7 ±0) + s * (32 ±0)`
		// Minimum execution time: 176_411_000 picoseconds.
		Weight::from_parts(182_882_369, 0)
			.saturating_add(Weight::from_parts(0, 11037))
			// Standard Error: 1_902
			.saturating_add(Weight::from_parts(1_581_866, 0).saturating_mul(s.into()))
	...
	fn poke_deposit() -> Weight {
		...
		//  Measured:  `7242`
		//  Estimated: `11037`
		// Minimum execution time: 142_331_000 picoseconds.
		Weight::from_parts(145_781_000, 0)
			.saturating_add(Weight::from_parts(0, 11037))
