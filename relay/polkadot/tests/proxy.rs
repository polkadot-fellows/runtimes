...
/// 7 more under `Any`, 5 more under `NonTransfer`). With 24 calls, the inner loop runs 480
/// times and makes at most 960 filter probes. Each probe is one `matches!` on an enum. The
